                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="sidebar-widget widget_tagcloud wow fadeInUp animated mb-30" data-wow-delay="0.2s">
                            ...
                            <div className="tagcloud mt-50">
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">beautiful</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">New York</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">droll</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">intimate</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">loving</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">travel</a>
                                <a className="tag-cloud-link" href="html/stories/demo/category.html">fighting </a>
                            </div>
                        </div>
                    </div>
